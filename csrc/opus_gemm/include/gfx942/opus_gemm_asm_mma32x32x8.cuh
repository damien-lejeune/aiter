...
void phase_compute_2x2(const VA& v_a, const VB& v_b, float16_acc* acc) {
    ...
    if constexpr (T::E_K == 8) {
        kstep_compute_2x2<T, 4>(v_a, v_b, acc);
        kstep_compute_2x2<T, 5>(v_a, v_b, acc);
        kstep_compute_2x2<T, 6>(v_a, v_b, acc);
        kstep_compute_2x2<T, 7>(v_a, v_b, acc);
    }
}
...
template<typename T, typename VA, typename VB>
__device__ __forceinline__
void phase_ab_prefetch_all_quadrants_2x2_ordered_nowait_ek8(
    const VA& v_a, const VB& v_b, float16_acc* acc,
    frag_b128<T::b_ds_read_insts>& v_b0_out, const unsigned* lds_b0_addrs,
    frag_b128<T::a_ds_read_insts>& v_a0_out, const unsigned* lds_a0_addrs,
    frag_b128<T::b_ds_read_insts>& v_b1_out, const unsigned* lds_b1_addrs,
    frag_b128<T::a_ds_read_insts>& v_a1_out, const unsigned* lds_a1_addrs)
{
    static_assert(T::E_M == 2 && T::E_N == 2 && T::E_K == 8);
    mfma32_prefetch_step_2x2<T, 0>(
        v_a, v_b, acc, v_b0_out, lds_b0_addrs, v_a0_out, lds_a0_addrs,
        v_b1_out, lds_b1_addrs, v_a1_out, lds_a1_addrs);
    mfma32_prefetch_step_2x2<T, 1>(
        v_a, v_b, acc, v_b0_out, lds_b0_addrs, v_a0_out, lds_a0_addrs,
        v_b1_out, lds_b1_addrs, v_a1_out, lds_a1_addrs);
    mfma32_prefetch_step_2x2<T, 2>(
        v_a, v_b, acc, v_b0_out, lds_b0_addrs, v_a0_out, lds_a0_addrs,
        v_b1_out, lds_b1_addrs, v_a1_out, lds_a1_addrs);
    mfma32_prefetch_step_2x2<T, 3>(
        v_a, v_b, acc, v_b0_out, lds_b0_addrs, v_a0_out, lds_a0_addrs,
        v_b1_out, lds_b1_addrs, v_a1_out, lds_a1_addrs);
    mfma32_prefetch_step_2x2<T, 4>(
        v_a, v_b, acc, v_b0_out, lds_b0_addrs, v_a0_out, lds_a0_addrs,
        v_b1_out, lds_b1_addrs, v_a1_out, lds_a1_addrs);
    mfma32_prefetch_step_2x2<T, 5>(
        v_a, v_b, acc, v_b0_out, lds_b0_addrs, v_a0_out, lds_a0_addrs,
        v_b1_out, lds_b1_addrs, v_a1_out, lds_a1_addrs);
    mfma32_prefetch_step_2x2<T, 6>(
        v_a, v_b, acc, v_b0_out, lds_b0_addrs, v_a0_out, lds_a0_addrs,
        v_b1_out, lds_b1_addrs, v_a1_out, lds_a1_addrs);
    mfma32_prefetch_step_2x2<T, 7>(
        v_a, v_b, acc, v_b0_out, lds_b0_addrs, v_a0_out, lds_a0_addrs,
        v_b1_out, lds_b1_addrs, v_a1_out, lds_a1_addrs);
}
...
template<typename T, typename VA, typename VB>
__device__ __forceinline__
void phase_ab_prefetch_all_quadrants_2x2_ordered_nowait_ek4(
    const VA& v_a, const VB& v_b, float16_acc* acc,
    frag_b128<T::b_ds_read_insts>& v_b0_out, const unsigned* lds_b0_addrs,
    frag_b128<T::a_ds_read_insts>& v_a0_out, const unsigned* lds_a0_addrs,
    frag_b128<T::b_ds_read_insts>& v_b1_out, const unsigned* lds_b1_addrs,
    ...
    frag_b128<T::a_ds_read_insts>& v_a1_out, const unsigned* lds_a1_addrs)
{
    ...
    if constexpr (T::E_K == 4) {
        phase_ab_prefetch_all_quadrants_2x2_ordered_nowait_ek4<T>(
            v_a, v_b, acc, v_b0_out, lds_b0_addrs, v_a0_out, lds_a0_addrs,
            v_b1_out, lds_b1_addrs, v_a1_out, lds_a1_addrs);
    } else {
        phase_ab_prefetch_all_quadrants_2x2_ordered_nowait_ek8<T>(
            v_a, v_b, acc, v_b0_out, lds_b0_addrs, v_a0_out, lds_a0_addrs,
            v_b1_out, lds_b1_addrs, v_a1_out, lds_a1_addrs);
    }
}
